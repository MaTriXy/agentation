  ...
  return (
    <div className="fd-container">
      <DemoTabs
        ...
        items={features.map(({ key, label }) => ({ value: key, label }))}
        value={activeFeature}
      ...
      <div className="sd-container" ref={containerRef}>
        ...
        >
          ...
          <div className="sd-header">
            ...
            <span className="sd-version">v3.1.2</span>
      ...
      <div className="demo-window sid-demo">
        ...
        <div className="demo-content sid-page" ref={contentRef}>
          ...
          <div className="sid-profile-info">
            ...
            <p className="sid-bio">head of design <span className="sid-mention">@x</span> &amp; <span className="sid-mention">@spacexai</span></p>
            ...
            <div className="sid-stats">
              ...
              <span><strong>220.9K</strong> Followers</span>
            </div>
          </div>
